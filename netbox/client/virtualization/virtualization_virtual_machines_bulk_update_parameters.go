...
func (o *VirtualizationVirtualMachinesBulkUpdateParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the virtualization virtual machines bulk update params
func (o *VirtualizationVirtualMachinesBulkUpdateParams) WithContext(ctx context.Context) *VirtualizationVirtualMachinesBulkUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the virtualization virtual machines bulk update params
func (o *VirtualizationVirtualMachinesBulkUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}
