...
func (o *UsersPermissionsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUsersPermissionsListOK()
...
func (o *UsersPermissionsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(UsersPermissionsListOKBody)
...
func (o *UsersPermissionsListOKBody) validateCount(formats strfmt.Registry) error {

	if err := validate.Required("usersPermissionsListOK"+"."+"count", "body", o.Count); err != nil {
		return err
	}
...
func (o *UsersPermissionsListOKBody) validateNext(formats strfmt.Registry) error {
	if swag.IsZero(o.Next) { // not required
		return nil
	}

	if err := validate.FormatOf("usersPermissionsListOK"+"."+"next", "body", "uri", o.Next.String(), formats); err != nil {
		return err
	}
...
func (o *UsersPermissionsListOKBody) validatePrevious(formats strfmt.Registry) error {
	if swag.IsZero(o.Previous) { // not required
		return nil
	}

	if err := validate.FormatOf("usersPermissionsListOK"+"."+"previous", "body", "uri", o.Previous.String(), formats); err != nil {
		return err
	}
...
func (o *UsersPermissionsListOKBody) validateResults(formats strfmt.Registry) error {

	if err := validate.Required("usersPermissionsListOK"+"."+"results", "body", o.Results); err != nil {
		return err
	}
...
func (o *UsersPermissionsListOKBody) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (o *UsersPermissionsListOKBody) UnmarshalBinary(b []byte) error {
	var res UsersPermissionsListOKBody
