...
func (o *CircuitsCircuitsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewCircuitsCircuitsBulkUpdateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewCircuitsCircuitsBulkUpdateDefault(code int) *CircuitsCircuitsBulkUpdateDefault {
	return &CircuitsCircuitsBulkUpdateDefault{
		_statusCode: code,
	}
}
...
func (o *CircuitsCircuitsBulkUpdateDefault) Code() int {
...
func (o *CircuitsCircuitsBulkUpdateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
