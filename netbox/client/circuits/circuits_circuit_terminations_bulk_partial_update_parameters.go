...
func (o *CircuitsCircuitTerminationsBulkPartialUpdateParams) WithTimeout(timeout time.Duration) *CircuitsCircuitTerminationsBulkPartialUpdateParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the circuits circuit terminations bulk partial update params
func (o *CircuitsCircuitTerminationsBulkPartialUpdateParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the circuits circuit terminations bulk partial update params
func (o *CircuitsCircuitTerminationsBulkPartialUpdateParams) WithContext(ctx context.Context) *CircuitsCircuitTerminationsBulkPartialUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the circuits circuit terminations bulk partial update params
func (o *CircuitsCircuitTerminationsBulkPartialUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the circuits circuit terminations bulk partial update params
func (o *CircuitsCircuitTerminationsBulkPartialUpdateParams) WithHTTPClient(client *http.Client) *CircuitsCircuitTerminationsBulkPartialUpdateParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the circuits circuit terminations bulk partial update params
func (o *CircuitsCircuitTerminationsBulkPartialUpdateParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithData adds the data to the circuits circuit terminations bulk partial update params
func (o *CircuitsCircuitTerminationsBulkPartialUpdateParams) WithData(data *models.WritableCircuitTermination) *CircuitsCircuitTerminationsBulkPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the circuits circuit terminations bulk partial update params
func (o *CircuitsCircuitTerminationsBulkPartialUpdateParams) SetData(data *models.WritableCircuitTermination) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *CircuitsCircuitTerminationsBulkPartialUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
