...
func (o *CircuitsProviderNetworksListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCircuitsProviderNetworksListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewCircuitsProviderNetworksListDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewCircuitsProviderNetworksListOK() *CircuitsProviderNetworksListOK {
	return &CircuitsProviderNetworksListOK{}
}
...
func (o *CircuitsProviderNetworksListOK) Error() string {
	return fmt.Sprintf("[GET /circuits/provider-networks/][%d] circuitsProviderNetworksListOK  %+v", 200, o.Payload)
}

func (o *CircuitsProviderNetworksListOK) String() string {
	return fmt.Sprintf("[GET /circuits/provider-networks/][%d] circuitsProviderNetworksListOK  %+v", 200, o.Payload)
}

func (o *CircuitsProviderNetworksListOK) GetPayload() *CircuitsProviderNetworksListOKBody {
	return o.Payload
}

func (o *CircuitsProviderNetworksListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(CircuitsProviderNetworksListOKBody)
...
func NewCircuitsProviderNetworksListDefault(code int) *CircuitsProviderNetworksListDefault {
	return &CircuitsProviderNetworksListDefault{
		_statusCode: code,
	}
}
...
func (o *CircuitsProviderNetworksListDefault) Code() int {
	return o._statusCode
}

// IsSuccess returns true when this circuits provider networks list default response has a 2xx status code
func (o *CircuitsProviderNetworksListDefault) IsSuccess() bool {
...
func (o *CircuitsProviderNetworksListDefault) IsCode(code int) bool {
	return o._statusCode == code
}

func (o *CircuitsProviderNetworksListDefault) Error() string {
	return fmt.Sprintf("[GET /circuits/provider-networks/][%d] circuits_provider-networks_list default  %+v", o._statusCode, o.Payload)
}

func (o *CircuitsProviderNetworksListDefault) String() string {
	return fmt.Sprintf("[GET /circuits/provider-networks/][%d] circuits_provider-networks_list default  %+v", o._statusCode, o.Payload)
}
...
func (o *CircuitsProviderNetworksListDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
/*
CircuitsProviderNetworksListOKBody circuits provider networks list o k body
swagger:model CircuitsProviderNetworksListOKBody
*/
...
func (o *CircuitsProviderNetworksListOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *CircuitsProviderNetworksListOKBody) validateCount(formats strfmt.Registry) error {

	if err := validate.Required("circuitsProviderNetworksListOK"+"."+"count", "body", o.Count); err != nil {
		return err
	}
...
func (o *CircuitsProviderNetworksListOKBody) validateNext(formats strfmt.Registry) error {
	if swag.IsZero(o.Next) { // not required
		return nil
	}

	if err := validate.FormatOf("circuitsProviderNetworksListOK"+"."+"next", "body", "uri", o.Next.String(), formats); err != nil {
		return err
	}
...
func (o *CircuitsProviderNetworksListOKBody) validatePrevious(formats strfmt.Registry) error {
	if swag.IsZero(o.Previous) { // not required
		return nil
	}

	if err := validate.FormatOf("circuitsProviderNetworksListOK"+"."+"previous", "body", "uri", o.Previous.String(), formats); err != nil {
		return err
	}
...
func (o *CircuitsProviderNetworksListOKBody) validateResults(formats strfmt.Registry) error {

	if err := validate.Required("circuitsProviderNetworksListOK"+"."+"results", "body", o.Results); err != nil {
		return err
	}
...
func (o *CircuitsProviderNetworksListOKBody) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (o *CircuitsProviderNetworksListOKBody) UnmarshalBinary(b []byte) error {
	var res CircuitsProviderNetworksListOKBody
