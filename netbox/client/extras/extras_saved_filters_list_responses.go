...
func (o *ExtrasSavedFiltersListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewExtrasSavedFiltersListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewExtrasSavedFiltersListDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewExtrasSavedFiltersListOK() *ExtrasSavedFiltersListOK {
	return &ExtrasSavedFiltersListOK{}
}
...
func (o *ExtrasSavedFiltersListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(ExtrasSavedFiltersListOKBody)
...
func NewExtrasSavedFiltersListDefault(code int) *ExtrasSavedFiltersListDefault {
	return &ExtrasSavedFiltersListDefault{
		_statusCode: code,
	}
}
...
*/
type ExtrasSavedFiltersListDefault struct {
	_statusCode int
...
func (o *ExtrasSavedFiltersListDefault) Error() string {
	return fmt.Sprintf("[GET /extras/saved-filters/][%d] extras_saved-filters_list default  %+v", o._statusCode, o.Payload)
}
...
func (o *ExtrasSavedFiltersListDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
/*
ExtrasSavedFiltersListOKBody extras saved filters list o k body
swagger:model ExtrasSavedFiltersListOKBody
*/
type ExtrasSavedFiltersListOKBody struct {
	...
	// results
	// Required: true
	Results []*models.SavedFilter `json:"results"`
}

// Validate validates this extras saved filters list o k body
...
func (o *ExtrasSavedFiltersListOKBody) validateCount(formats strfmt.Registry) error {

	if err := validate.Required("extrasSavedFiltersListOK"+"."+"count", "body", o.Count); err != nil {
		return err
	}
...
func (o *ExtrasSavedFiltersListOKBody) validateNext(formats strfmt.Registry) error {
	if swag.IsZero(o.Next) { // not required
		return nil
	}

	if err := validate.FormatOf("extrasSavedFiltersListOK"+"."+"next", "body", "uri", o.Next.String(), formats); err != nil {
		return err
	}
...
func (o *ExtrasSavedFiltersListOKBody) validatePrevious(formats strfmt.Registry) error {
	if swag.IsZero(o.Previous) { // not required
		return nil
	}

	if err := validate.FormatOf("extrasSavedFiltersListOK"+"."+"previous", "body", "uri", o.Previous.String(), formats); err != nil {
		return err
	}
...
func (o *ExtrasSavedFiltersListOKBody) validateResults(formats strfmt.Registry) error {

	if err := validate.Required("extrasSavedFiltersListOK"+"."+"results", "body", o.Results); err != nil {
		return err
	}
		...
		if o.Results[i] != nil {
			if err := o.Results[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("extrasSavedFiltersListOK" + "." + "results" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("extrasSavedFiltersListOK" + "." + "results" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *ExtrasSavedFiltersListOKBody) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (o *ExtrasSavedFiltersListOKBody) UnmarshalBinary(b []byte) error {
	var res ExtrasSavedFiltersListOKBody
