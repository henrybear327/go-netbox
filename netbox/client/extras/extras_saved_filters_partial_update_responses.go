...
func (o *ExtrasSavedFiltersPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewExtrasSavedFiltersPartialUpdateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *ExtrasSavedFiltersPartialUpdateOK) Error() string {
	return fmt.Sprintf("[PATCH /extras/saved-filters/{id}/][%d] extrasSavedFiltersPartialUpdateOK  %+v", 200, o.Payload)
}
...
func NewExtrasSavedFiltersPartialUpdateDefault(code int) *ExtrasSavedFiltersPartialUpdateDefault {
	return &ExtrasSavedFiltersPartialUpdateDefault{
		_statusCode: code,
	}
}
...
*/
type ExtrasSavedFiltersPartialUpdateDefault struct {
	_statusCode int
...
func (o *ExtrasSavedFiltersPartialUpdateDefault) Error() string {
	return fmt.Sprintf("[PATCH /extras/saved-filters/{id}/][%d] extras_saved-filters_partial_update default  %+v", o._statusCode, o.Payload)
}
...
func (o *ExtrasSavedFiltersPartialUpdateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
