...
func (o *ExtrasSavedFiltersReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewExtrasSavedFiltersReadDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *ExtrasSavedFiltersReadOK) Error() string {
	return fmt.Sprintf("[GET /extras/saved-filters/{id}/][%d] extrasSavedFiltersReadOK  %+v", 200, o.Payload)
}
...
func NewExtrasSavedFiltersReadDefault(code int) *ExtrasSavedFiltersReadDefault {
	return &ExtrasSavedFiltersReadDefault{
		_statusCode: code,
	}
}
...
*/
type ExtrasSavedFiltersReadDefault struct {
	_statusCode int
...
func (o *ExtrasSavedFiltersReadDefault) Error() string {
	return fmt.Sprintf("[GET /extras/saved-filters/{id}/][%d] extras_saved-filters_read default  %+v", o._statusCode, o.Payload)
}
...
func (o *ExtrasSavedFiltersReadDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
