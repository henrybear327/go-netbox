...
func (o *ExtrasExportTemplatesBulkUpdateOK) String() string {
	return fmt.Sprintf("[PUT /extras/export-templates/][%d] extrasExportTemplatesBulkUpdateOK  %+v", 200, o.Payload)
}
...
func (o *ExtrasExportTemplatesBulkUpdateDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this extras export templates bulk update default response has a 3xx status code
func (o *ExtrasExportTemplatesBulkUpdateDefault) IsRedirect() bool {
...
func (o *ExtrasExportTemplatesBulkUpdateDefault) IsCode(code int) bool {
...
func (o *ExtrasExportTemplatesBulkUpdateDefault) String() string {
	return fmt.Sprintf("[PUT /extras/export-templates/][%d] extras_export-templates_bulk_update default  %+v", o._statusCode, o.Payload)
}
