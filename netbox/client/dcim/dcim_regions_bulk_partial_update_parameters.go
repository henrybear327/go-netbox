...
// NewDcimRegionsBulkPartialUpdateParams creates a new DcimRegionsBulkPartialUpdateParams object,
...
func NewDcimRegionsBulkPartialUpdateParams() *DcimRegionsBulkPartialUpdateParams {
	return &DcimRegionsBulkPartialUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDcimRegionsBulkPartialUpdateParamsWithTimeout creates a new DcimRegionsBulkPartialUpdateParams object
...
// NewDcimRegionsBulkPartialUpdateParamsWithContext creates a new DcimRegionsBulkPartialUpdateParams object
...
// NewDcimRegionsBulkPartialUpdateParamsWithHTTPClient creates a new DcimRegionsBulkPartialUpdateParams object
...
func (o *DcimRegionsBulkPartialUpdateParams) WithDefaults() *DcimRegionsBulkPartialUpdateParams {
	o.SetDefaults()
	return o
}
...
func (o *DcimRegionsBulkPartialUpdateParams) WithTimeout(timeout time.Duration) *DcimRegionsBulkPartialUpdateParams {
...
func (o *DcimRegionsBulkPartialUpdateParams) WithContext(ctx context.Context) *DcimRegionsBulkPartialUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the dcim regions bulk partial update params
func (o *DcimRegionsBulkPartialUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the dcim regions bulk partial update params
func (o *DcimRegionsBulkPartialUpdateParams) WithHTTPClient(client *http.Client) *DcimRegionsBulkPartialUpdateParams {
...
func (o *DcimRegionsBulkPartialUpdateParams) WithData(data *models.WritableRegion) *DcimRegionsBulkPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim regions bulk partial update params
func (o *DcimRegionsBulkPartialUpdateParams) SetData(data *models.WritableRegion) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *DcimRegionsBulkPartialUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
