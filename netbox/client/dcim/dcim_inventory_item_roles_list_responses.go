...
func (o *DcimInventoryItemRolesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewDcimInventoryItemRolesListDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDcimInventoryItemRolesListDefault(code int) *DcimInventoryItemRolesListDefault {
	return &DcimInventoryItemRolesListDefault{
		_statusCode: code,
	}
}
...
*/
type DcimInventoryItemRolesListDefault struct {
	_statusCode int

	Payload interface{}
}

// Code gets the status code for the dcim inventory item roles list default response
func (o *DcimInventoryItemRolesListDefault) Code() int {
...
func (o *DcimInventoryItemRolesListDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
