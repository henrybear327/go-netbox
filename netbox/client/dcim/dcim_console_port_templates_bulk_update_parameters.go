...
func (o *DcimConsolePortTemplatesBulkUpdateParams) WithTimeout(timeout time.Duration) *DcimConsolePortTemplatesBulkUpdateParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the dcim console port templates bulk update params
func (o *DcimConsolePortTemplatesBulkUpdateParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the dcim console port templates bulk update params
func (o *DcimConsolePortTemplatesBulkUpdateParams) WithContext(ctx context.Context) *DcimConsolePortTemplatesBulkUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the dcim console port templates bulk update params
func (o *DcimConsolePortTemplatesBulkUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the dcim console port templates bulk update params
func (o *DcimConsolePortTemplatesBulkUpdateParams) WithHTTPClient(client *http.Client) *DcimConsolePortTemplatesBulkUpdateParams {
...
func (o *DcimConsolePortTemplatesBulkUpdateParams) WithData(data *models.WritableConsolePortTemplate) *DcimConsolePortTemplatesBulkUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim console port templates bulk update params
func (o *DcimConsolePortTemplatesBulkUpdateParams) SetData(data *models.WritableConsolePortTemplate) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *DcimConsolePortTemplatesBulkUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
