...
func NewDcimPlatformsBulkPartialUpdateParams() *DcimPlatformsBulkPartialUpdateParams {
	return &DcimPlatformsBulkPartialUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDcimPlatformsBulkPartialUpdateParamsWithTimeout creates a new DcimPlatformsBulkPartialUpdateParams object
...
// NewDcimPlatformsBulkPartialUpdateParamsWithContext creates a new DcimPlatformsBulkPartialUpdateParams object
...
// NewDcimPlatformsBulkPartialUpdateParamsWithHTTPClient creates a new DcimPlatformsBulkPartialUpdateParams object
...
func (o *DcimPlatformsBulkPartialUpdateParams) WithDefaults() *DcimPlatformsBulkPartialUpdateParams {
	o.SetDefaults()
	return o
}
...
func (o *DcimPlatformsBulkPartialUpdateParams) WithTimeout(timeout time.Duration) *DcimPlatformsBulkPartialUpdateParams {
...
func (o *DcimPlatformsBulkPartialUpdateParams) WithContext(ctx context.Context) *DcimPlatformsBulkPartialUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the dcim platforms bulk partial update params
func (o *DcimPlatformsBulkPartialUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the dcim platforms bulk partial update params
func (o *DcimPlatformsBulkPartialUpdateParams) WithHTTPClient(client *http.Client) *DcimPlatformsBulkPartialUpdateParams {
...
func (o *DcimPlatformsBulkPartialUpdateParams) WithData(data *models.WritablePlatform) *DcimPlatformsBulkPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim platforms bulk partial update params
func (o *DcimPlatformsBulkPartialUpdateParams) SetData(data *models.WritablePlatform) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *DcimPlatformsBulkPartialUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
