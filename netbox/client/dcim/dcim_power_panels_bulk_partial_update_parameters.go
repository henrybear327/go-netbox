...
// NewDcimPowerPanelsBulkPartialUpdateParams creates a new DcimPowerPanelsBulkPartialUpdateParams object,
...
func NewDcimPowerPanelsBulkPartialUpdateParams() *DcimPowerPanelsBulkPartialUpdateParams {
	return &DcimPowerPanelsBulkPartialUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDcimPowerPanelsBulkPartialUpdateParamsWithTimeout creates a new DcimPowerPanelsBulkPartialUpdateParams object
...
// NewDcimPowerPanelsBulkPartialUpdateParamsWithContext creates a new DcimPowerPanelsBulkPartialUpdateParams object
...
// NewDcimPowerPanelsBulkPartialUpdateParamsWithHTTPClient creates a new DcimPowerPanelsBulkPartialUpdateParams object
...
func (o *DcimPowerPanelsBulkPartialUpdateParams) WithDefaults() *DcimPowerPanelsBulkPartialUpdateParams {
	o.SetDefaults()
	return o
}
...
func (o *DcimPowerPanelsBulkPartialUpdateParams) WithTimeout(timeout time.Duration) *DcimPowerPanelsBulkPartialUpdateParams {
...
func (o *DcimPowerPanelsBulkPartialUpdateParams) WithContext(ctx context.Context) *DcimPowerPanelsBulkPartialUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the dcim power panels bulk partial update params
func (o *DcimPowerPanelsBulkPartialUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the dcim power panels bulk partial update params
func (o *DcimPowerPanelsBulkPartialUpdateParams) WithHTTPClient(client *http.Client) *DcimPowerPanelsBulkPartialUpdateParams {
...
func (o *DcimPowerPanelsBulkPartialUpdateParams) WithData(data *models.WritablePowerPanel) *DcimPowerPanelsBulkPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim power panels bulk partial update params
func (o *DcimPowerPanelsBulkPartialUpdateParams) SetData(data *models.WritablePowerPanel) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *DcimPowerPanelsBulkPartialUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
