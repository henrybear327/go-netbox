...
// IsSuccess returns true when this dcim site groups bulk partial update default response has a 2xx status code
func (o *DcimSiteGroupsBulkPartialUpdateDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this dcim site groups bulk partial update default response has a 3xx status code
func (o *DcimSiteGroupsBulkPartialUpdateDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this dcim site groups bulk partial update default response has a 4xx status code
func (o *DcimSiteGroupsBulkPartialUpdateDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this dcim site groups bulk partial update default response has a 5xx status code
func (o *DcimSiteGroupsBulkPartialUpdateDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this dcim site groups bulk partial update default response a status code equal to that given
func (o *DcimSiteGroupsBulkPartialUpdateDefault) IsCode(code int) bool {
...
func (o *DcimSiteGroupsBulkPartialUpdateDefault) String() string {
	return fmt.Sprintf("[PATCH /dcim/site-groups/][%d] dcim_site-groups_bulk_partial_update default  %+v", o._statusCode, o.Payload)
}
