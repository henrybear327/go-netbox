...
func NewDcimInterfacesBulkUpdateParams() *DcimInterfacesBulkUpdateParams {
	return &DcimInterfacesBulkUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDcimInterfacesBulkUpdateParamsWithTimeout creates a new DcimInterfacesBulkUpdateParams object
...
// NewDcimInterfacesBulkUpdateParamsWithContext creates a new DcimInterfacesBulkUpdateParams object
...
// NewDcimInterfacesBulkUpdateParamsWithHTTPClient creates a new DcimInterfacesBulkUpdateParams object
...
func (o *DcimInterfacesBulkUpdateParams) WithDefaults() *DcimInterfacesBulkUpdateParams {
	o.SetDefaults()
	return o
}
...
func (o *DcimInterfacesBulkUpdateParams) WithTimeout(timeout time.Duration) *DcimInterfacesBulkUpdateParams {
...
func (o *DcimInterfacesBulkUpdateParams) WithContext(ctx context.Context) *DcimInterfacesBulkUpdateParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DcimInterfacesBulkUpdateParams) WithHTTPClient(client *http.Client) *DcimInterfacesBulkUpdateParams {
...
func (o *DcimInterfacesBulkUpdateParams) WithData(data *models.WritableInterface) *DcimInterfacesBulkUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim interfaces bulk update params
func (o *DcimInterfacesBulkUpdateParams) SetData(data *models.WritableInterface) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *DcimInterfacesBulkUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
