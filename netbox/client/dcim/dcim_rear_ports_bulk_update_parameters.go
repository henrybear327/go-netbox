...
// NewDcimRearPortsBulkUpdateParams creates a new DcimRearPortsBulkUpdateParams object,
...
func NewDcimRearPortsBulkUpdateParams() *DcimRearPortsBulkUpdateParams {
	return &DcimRearPortsBulkUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDcimRearPortsBulkUpdateParamsWithTimeout creates a new DcimRearPortsBulkUpdateParams object
...
// NewDcimRearPortsBulkUpdateParamsWithContext creates a new DcimRearPortsBulkUpdateParams object
...
// NewDcimRearPortsBulkUpdateParamsWithHTTPClient creates a new DcimRearPortsBulkUpdateParams object
...
func (o *DcimRearPortsBulkUpdateParams) WithDefaults() *DcimRearPortsBulkUpdateParams {
	o.SetDefaults()
	return o
}
...
func (o *DcimRearPortsBulkUpdateParams) WithTimeout(timeout time.Duration) *DcimRearPortsBulkUpdateParams {
...
func (o *DcimRearPortsBulkUpdateParams) WithContext(ctx context.Context) *DcimRearPortsBulkUpdateParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DcimRearPortsBulkUpdateParams) WithHTTPClient(client *http.Client) *DcimRearPortsBulkUpdateParams {
...
func (o *DcimRearPortsBulkUpdateParams) WithData(data *models.WritableRearPort) *DcimRearPortsBulkUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim rear ports bulk update params
func (o *DcimRearPortsBulkUpdateParams) SetData(data *models.WritableRearPort) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *DcimRearPortsBulkUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
