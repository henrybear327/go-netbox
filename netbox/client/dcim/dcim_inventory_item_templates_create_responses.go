...
func (o *DcimInventoryItemTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		result := NewDcimInventoryItemTemplatesCreateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDcimInventoryItemTemplatesCreateDefault(code int) *DcimInventoryItemTemplatesCreateDefault {
	return &DcimInventoryItemTemplatesCreateDefault{
		_statusCode: code,
	}
}
...
DcimInventoryItemTemplatesCreateDefault dcim inventory item templates create default
*/
type DcimInventoryItemTemplatesCreateDefault struct {
	_statusCode int
...
// IsRedirect returns true when this dcim inventory item templates create default response has a 3xx status code
func (o *DcimInventoryItemTemplatesCreateDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this dcim inventory item templates create default response has a 4xx status code
func (o *DcimInventoryItemTemplatesCreateDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this dcim inventory item templates create default response has a 5xx status code
func (o *DcimInventoryItemTemplatesCreateDefault) IsServerError() bool {
...
func (o *DcimInventoryItemTemplatesCreateDefault) Error() string {
	return fmt.Sprintf("[POST /dcim/inventory-item-templates/][%d] dcim_inventory-item-templates_create default  %+v", o._statusCode, o.Payload)
}

func (o *DcimInventoryItemTemplatesCreateDefault) String() string {
	return fmt.Sprintf("[POST /dcim/inventory-item-templates/][%d] dcim_inventory-item-templates_create default  %+v", o._statusCode, o.Payload)
}

func (o *DcimInventoryItemTemplatesCreateDefault) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimInventoryItemTemplatesCreateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
