...
func (o *DcimPowerOutletsBulkUpdateParams) WithTimeout(timeout time.Duration) *DcimPowerOutletsBulkUpdateParams {
...
func (o *DcimPowerOutletsBulkUpdateParams) WithContext(ctx context.Context) *DcimPowerOutletsBulkUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the dcim power outlets bulk update params
func (o *DcimPowerOutletsBulkUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the dcim power outlets bulk update params
func (o *DcimPowerOutletsBulkUpdateParams) WithHTTPClient(client *http.Client) *DcimPowerOutletsBulkUpdateParams {
...
func (o *DcimPowerOutletsBulkUpdateParams) WithData(data *models.WritablePowerOutlet) *DcimPowerOutletsBulkUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim power outlets bulk update params
func (o *DcimPowerOutletsBulkUpdateParams) SetData(data *models.WritablePowerOutlet) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *DcimPowerOutletsBulkUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
