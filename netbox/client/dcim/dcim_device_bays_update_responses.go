...
func (o *DcimDeviceBaysUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewDcimDeviceBaysUpdateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewDcimDeviceBaysUpdateDefault(code int) *DcimDeviceBaysUpdateDefault {
	return &DcimDeviceBaysUpdateDefault{
		_statusCode: code,
	}
}
...
// IsSuccess returns true when this dcim device bays update default response has a 2xx status code
func (o *DcimDeviceBaysUpdateDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this dcim device bays update default response has a 3xx status code
func (o *DcimDeviceBaysUpdateDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this dcim device bays update default response has a 4xx status code
func (o *DcimDeviceBaysUpdateDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this dcim device bays update default response has a 5xx status code
func (o *DcimDeviceBaysUpdateDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this dcim device bays update default response a status code equal to that given
func (o *DcimDeviceBaysUpdateDefault) IsCode(code int) bool {
	return o._statusCode == code
}

func (o *DcimDeviceBaysUpdateDefault) Error() string {
	return fmt.Sprintf("[PUT /dcim/device-bays/{id}/][%d] dcim_device-bays_update default  %+v", o._statusCode, o.Payload)
}

func (o *DcimDeviceBaysUpdateDefault) String() string {
	return fmt.Sprintf("[PUT /dcim/device-bays/{id}/][%d] dcim_device-bays_update default  %+v", o._statusCode, o.Payload)
}
...
func (o *DcimDeviceBaysUpdateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
