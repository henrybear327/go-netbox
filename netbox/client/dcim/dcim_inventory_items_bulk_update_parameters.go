...
// NewDcimInventoryItemsBulkUpdateParams creates a new DcimInventoryItemsBulkUpdateParams object,
...
func NewDcimInventoryItemsBulkUpdateParams() *DcimInventoryItemsBulkUpdateParams {
	return &DcimInventoryItemsBulkUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDcimInventoryItemsBulkUpdateParamsWithTimeout creates a new DcimInventoryItemsBulkUpdateParams object
...
// NewDcimInventoryItemsBulkUpdateParamsWithContext creates a new DcimInventoryItemsBulkUpdateParams object
...
// NewDcimInventoryItemsBulkUpdateParamsWithHTTPClient creates a new DcimInventoryItemsBulkUpdateParams object
...
func (o *DcimInventoryItemsBulkUpdateParams) WithDefaults() *DcimInventoryItemsBulkUpdateParams {
	o.SetDefaults()
	return o
}
...
func (o *DcimInventoryItemsBulkUpdateParams) WithTimeout(timeout time.Duration) *DcimInventoryItemsBulkUpdateParams {
...
func (o *DcimInventoryItemsBulkUpdateParams) WithContext(ctx context.Context) *DcimInventoryItemsBulkUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the dcim inventory items bulk update params
func (o *DcimInventoryItemsBulkUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the dcim inventory items bulk update params
func (o *DcimInventoryItemsBulkUpdateParams) WithHTTPClient(client *http.Client) *DcimInventoryItemsBulkUpdateParams {
...
func (o *DcimInventoryItemsBulkUpdateParams) WithData(data *models.WritableInventoryItem) *DcimInventoryItemsBulkUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim inventory items bulk update params
func (o *DcimInventoryItemsBulkUpdateParams) SetData(data *models.WritableInventoryItem) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *DcimInventoryItemsBulkUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
