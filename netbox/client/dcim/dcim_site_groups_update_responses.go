...
// IsSuccess returns true when this dcim site groups update default response has a 2xx status code
func (o *DcimSiteGroupsUpdateDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this dcim site groups update default response has a 3xx status code
func (o *DcimSiteGroupsUpdateDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this dcim site groups update default response has a 4xx status code
func (o *DcimSiteGroupsUpdateDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this dcim site groups update default response has a 5xx status code
func (o *DcimSiteGroupsUpdateDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this dcim site groups update default response a status code equal to that given
func (o *DcimSiteGroupsUpdateDefault) IsCode(code int) bool {
...
func (o *DcimSiteGroupsUpdateDefault) String() string {
	return fmt.Sprintf("[PUT /dcim/site-groups/{id}/][%d] dcim_site-groups_update default  %+v", o._statusCode, o.Payload)
}
