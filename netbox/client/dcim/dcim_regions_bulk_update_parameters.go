...
// NewDcimRegionsBulkUpdateParams creates a new DcimRegionsBulkUpdateParams object,
...
func NewDcimRegionsBulkUpdateParams() *DcimRegionsBulkUpdateParams {
	return &DcimRegionsBulkUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDcimRegionsBulkUpdateParamsWithTimeout creates a new DcimRegionsBulkUpdateParams object
...
// NewDcimRegionsBulkUpdateParamsWithContext creates a new DcimRegionsBulkUpdateParams object
...
// NewDcimRegionsBulkUpdateParamsWithHTTPClient creates a new DcimRegionsBulkUpdateParams object
...
func (o *DcimRegionsBulkUpdateParams) WithDefaults() *DcimRegionsBulkUpdateParams {
	o.SetDefaults()
	return o
}
...
func (o *DcimRegionsBulkUpdateParams) WithTimeout(timeout time.Duration) *DcimRegionsBulkUpdateParams {
...
func (o *DcimRegionsBulkUpdateParams) WithContext(ctx context.Context) *DcimRegionsBulkUpdateParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DcimRegionsBulkUpdateParams) WithHTTPClient(client *http.Client) *DcimRegionsBulkUpdateParams {
...
func (o *DcimRegionsBulkUpdateParams) WithData(data *models.WritableRegion) *DcimRegionsBulkUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the dcim regions bulk update params
func (o *DcimRegionsBulkUpdateParams) SetData(data *models.WritableRegion) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *DcimRegionsBulkUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
