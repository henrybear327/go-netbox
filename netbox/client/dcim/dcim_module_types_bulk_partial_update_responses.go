...
// IsSuccess returns true when this dcim module types bulk partial update default response has a 2xx status code
func (o *DcimModuleTypesBulkPartialUpdateDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this dcim module types bulk partial update default response has a 3xx status code
func (o *DcimModuleTypesBulkPartialUpdateDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this dcim module types bulk partial update default response has a 4xx status code
func (o *DcimModuleTypesBulkPartialUpdateDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this dcim module types bulk partial update default response has a 5xx status code
func (o *DcimModuleTypesBulkPartialUpdateDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this dcim module types bulk partial update default response a status code equal to that given
func (o *DcimModuleTypesBulkPartialUpdateDefault) IsCode(code int) bool {
...
func (o *DcimModuleTypesBulkPartialUpdateDefault) String() string {
	return fmt.Sprintf("[PATCH /dcim/module-types/][%d] dcim_module-types_bulk_partial_update default  %+v", o._statusCode, o.Payload)
}
