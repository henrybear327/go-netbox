...
// NewTenancyContactGroupsPartialUpdateParams creates a new TenancyContactGroupsPartialUpdateParams object,
...
func NewTenancyContactGroupsPartialUpdateParams() *TenancyContactGroupsPartialUpdateParams {
	return &TenancyContactGroupsPartialUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewTenancyContactGroupsPartialUpdateParamsWithTimeout creates a new TenancyContactGroupsPartialUpdateParams object
...
// NewTenancyContactGroupsPartialUpdateParamsWithContext creates a new TenancyContactGroupsPartialUpdateParams object
...
// NewTenancyContactGroupsPartialUpdateParamsWithHTTPClient creates a new TenancyContactGroupsPartialUpdateParams object
...
func (o *TenancyContactGroupsPartialUpdateParams) WithDefaults() *TenancyContactGroupsPartialUpdateParams {
	o.SetDefaults()
	return o
}
...
func (o *TenancyContactGroupsPartialUpdateParams) WithTimeout(timeout time.Duration) *TenancyContactGroupsPartialUpdateParams {
...
func (o *TenancyContactGroupsPartialUpdateParams) WithContext(ctx context.Context) *TenancyContactGroupsPartialUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the tenancy contact groups partial update params
func (o *TenancyContactGroupsPartialUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the tenancy contact groups partial update params
func (o *TenancyContactGroupsPartialUpdateParams) WithHTTPClient(client *http.Client) *TenancyContactGroupsPartialUpdateParams {
...
func (o *TenancyContactGroupsPartialUpdateParams) WithData(data *models.WritableContactGroup) *TenancyContactGroupsPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the tenancy contact groups partial update params
func (o *TenancyContactGroupsPartialUpdateParams) SetData(data *models.WritableContactGroup) {
	o.Data = data
}

// WithID adds the id to the tenancy contact groups partial update params
func (o *TenancyContactGroupsPartialUpdateParams) WithID(id int64) *TenancyContactGroupsPartialUpdateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the tenancy contact groups partial update params
func (o *TenancyContactGroupsPartialUpdateParams) SetID(id int64) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *TenancyContactGroupsPartialUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
