...
func (o *TenancyContactRolesCreateParams) WithData(data *models.ContactRole) *TenancyContactRolesCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the tenancy contact roles create params
func (o *TenancyContactRolesCreateParams) SetData(data *models.ContactRole) {
	o.Data = data
}
