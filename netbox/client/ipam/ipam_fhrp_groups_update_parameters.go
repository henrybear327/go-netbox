...
// NewIpamFhrpGroupsUpdateParams creates a new IpamFhrpGroupsUpdateParams object,
...
func NewIpamFhrpGroupsUpdateParams() *IpamFhrpGroupsUpdateParams {
	return &IpamFhrpGroupsUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewIpamFhrpGroupsUpdateParamsWithTimeout creates a new IpamFhrpGroupsUpdateParams object
...
// NewIpamFhrpGroupsUpdateParamsWithContext creates a new IpamFhrpGroupsUpdateParams object
...
// NewIpamFhrpGroupsUpdateParamsWithHTTPClient creates a new IpamFhrpGroupsUpdateParams object
...
func (o *IpamFhrpGroupsUpdateParams) WithDefaults() *IpamFhrpGroupsUpdateParams {
	o.SetDefaults()
	return o
}
...
func (o *IpamFhrpGroupsUpdateParams) WithTimeout(timeout time.Duration) *IpamFhrpGroupsUpdateParams {
...
func (o *IpamFhrpGroupsUpdateParams) WithContext(ctx context.Context) *IpamFhrpGroupsUpdateParams {
	o.SetContext(ctx)
	return o
}
...
func (o *IpamFhrpGroupsUpdateParams) WithHTTPClient(client *http.Client) *IpamFhrpGroupsUpdateParams {
...
func (o *IpamFhrpGroupsUpdateParams) WithData(data *models.FHRPGroup) *IpamFhrpGroupsUpdateParams {
	o.SetData(data)
	return o
}
...
func (o *IpamFhrpGroupsUpdateParams) WithID(id int64) *IpamFhrpGroupsUpdateParams {
	o.SetID(id)
	return o
}
...
func (o *IpamFhrpGroupsUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
