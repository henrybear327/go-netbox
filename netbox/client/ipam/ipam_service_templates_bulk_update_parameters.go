...
// NewIpamServiceTemplatesBulkUpdateParams creates a new IpamServiceTemplatesBulkUpdateParams object,
...
func NewIpamServiceTemplatesBulkUpdateParams() *IpamServiceTemplatesBulkUpdateParams {
	return &IpamServiceTemplatesBulkUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewIpamServiceTemplatesBulkUpdateParamsWithTimeout creates a new IpamServiceTemplatesBulkUpdateParams object
...
// NewIpamServiceTemplatesBulkUpdateParamsWithContext creates a new IpamServiceTemplatesBulkUpdateParams object
...
// NewIpamServiceTemplatesBulkUpdateParamsWithHTTPClient creates a new IpamServiceTemplatesBulkUpdateParams object
...
func (o *IpamServiceTemplatesBulkUpdateParams) WithDefaults() *IpamServiceTemplatesBulkUpdateParams {
	o.SetDefaults()
	return o
}
...
func (o *IpamServiceTemplatesBulkUpdateParams) WithTimeout(timeout time.Duration) *IpamServiceTemplatesBulkUpdateParams {
...
func (o *IpamServiceTemplatesBulkUpdateParams) WithContext(ctx context.Context) *IpamServiceTemplatesBulkUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the ipam service templates bulk update params
func (o *IpamServiceTemplatesBulkUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the ipam service templates bulk update params
func (o *IpamServiceTemplatesBulkUpdateParams) WithHTTPClient(client *http.Client) *IpamServiceTemplatesBulkUpdateParams {
...
func (o *IpamServiceTemplatesBulkUpdateParams) WithData(data *models.WritableServiceTemplate) *IpamServiceTemplatesBulkUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam service templates bulk update params
func (o *IpamServiceTemplatesBulkUpdateParams) SetData(data *models.WritableServiceTemplate) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *IpamServiceTemplatesBulkUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
