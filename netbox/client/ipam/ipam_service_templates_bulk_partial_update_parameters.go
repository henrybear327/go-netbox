...
// NewIpamServiceTemplatesBulkPartialUpdateParams creates a new IpamServiceTemplatesBulkPartialUpdateParams object,
...
func NewIpamServiceTemplatesBulkPartialUpdateParams() *IpamServiceTemplatesBulkPartialUpdateParams {
	return &IpamServiceTemplatesBulkPartialUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewIpamServiceTemplatesBulkPartialUpdateParamsWithTimeout creates a new IpamServiceTemplatesBulkPartialUpdateParams object
...
// NewIpamServiceTemplatesBulkPartialUpdateParamsWithContext creates a new IpamServiceTemplatesBulkPartialUpdateParams object
...
// NewIpamServiceTemplatesBulkPartialUpdateParamsWithHTTPClient creates a new IpamServiceTemplatesBulkPartialUpdateParams object
...
func (o *IpamServiceTemplatesBulkPartialUpdateParams) WithDefaults() *IpamServiceTemplatesBulkPartialUpdateParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *IpamServiceTemplatesBulkPartialUpdateParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the ipam service templates bulk partial update params
func (o *IpamServiceTemplatesBulkPartialUpdateParams) WithTimeout(timeout time.Duration) *IpamServiceTemplatesBulkPartialUpdateParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the ipam service templates bulk partial update params
func (o *IpamServiceTemplatesBulkPartialUpdateParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the ipam service templates bulk partial update params
func (o *IpamServiceTemplatesBulkPartialUpdateParams) WithContext(ctx context.Context) *IpamServiceTemplatesBulkPartialUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the ipam service templates bulk partial update params
func (o *IpamServiceTemplatesBulkPartialUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the ipam service templates bulk partial update params
func (o *IpamServiceTemplatesBulkPartialUpdateParams) WithHTTPClient(client *http.Client) *IpamServiceTemplatesBulkPartialUpdateParams {
...
func (o *IpamServiceTemplatesBulkPartialUpdateParams) WithData(data *models.WritableServiceTemplate) *IpamServiceTemplatesBulkPartialUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam service templates bulk partial update params
func (o *IpamServiceTemplatesBulkPartialUpdateParams) SetData(data *models.WritableServiceTemplate) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *IpamServiceTemplatesBulkPartialUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
